...
// ic_timer_prescaler=1; output_timer_prescaler=1;
// IC_TIMER_REGISTER->CNT = 0xffff; 		buffer_divider = 44;
// dshot_runout_timer = 65000; 		armed_count_threshold = 10000;
// buffer_padding = 7; 		buffersize = 32;
// 	}
...
//	int lastnumber = dma_buffer[0];
//	for ( int j = 1 ; j < 31; j++){
//		if((dma_buffer[j] - lastnumber) < smallestnumber){ // blank
// space 			smallestnumber = dma_buffer[j] - lastnumber;
//		}
//		lastnumber = dma_buffer[j];
//	}
...
//				}
//			}else{
//			servorawinput = map((dma_buffer[j] - lastnumber),
// servo_low_threshold, servo_high_threshold, 0, 2000);
//			}
//			break;
//		}
//		lastnumber = dma_buffer[j];
...
//  	receiveDshotDma();             //holy smokes.. reverse the line and set
//  up dma again
//   	return;
//    }else{
//		sendDshotDma();
...
// IC_TIMER_CHANNEL,
// LL_TIM_IC_POLARITY_RISING); // setup rising pin trigger.
//     		receiveDshotDma();
